...
(* OASIS_START *)
(* DO NOT EDIT (digest: 25a2d8d5917cf47cdfc10dce9f753e67) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         ["-use-ocamlfind"; "-plugin-tags"; "'package(eliom.ocamlbuild)'"];
     test = [];
     doc = [];
     ...
     package =
       {
          ...
          alpha_features = ["ocamlbuild_more_args"; "compiled_setup_ml"];
          beta_features = [];
          name = "oas2";
          version = "1.0";
          license =
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [FindlibPackage ("eliom.server", None)];
                      bs_build_tools =
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [FindlibPackage ("eliom.client", None)];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlbuild"
                        ];
                      bs_c_sources = [];
                   ...
                   {exec_custom = false; exec_main_is = "myprog.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "(\134\205\1394%\212\241\005Ep\182\187\158le";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
